                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @php
                                            $ranking = 1;
                                        @endphp
                                        @foreach (topmember() as $s)
                                            <tr>
                                                <td>{{$ranking}}</td>
                                                <td><div class="d-flex">
                                                    <div class="usr-img-frame mr-2 rounded-circle">
                                                        <img alt="avatar" class="img-fluid rounded-circle" src="{{$s->getAvatar()}}">
                                                    </div>
                                                    <p class="align-self-center mb-0">{{$s->nama_lengkap()}}</p>
                                                </div></td>
